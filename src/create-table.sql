...
-- 2. Asegurar que RLS esté activado (opcional según la elección del usuario)
ALTER TABLE articulos ENABLE ROW LEVEL SECURITY;

-- 3. Crear política de lectura pública para que la web descargue las noticias
CREATE POLICY "Permitir lectura pública" ON articulos 
  FOR SELECT USING (true);

-- 4. Insertar artículos iniciales
INSERT INTO articulos (slug, title, description, date, category, image, content)
VALUES 
(
  'dominio-hosting-servidor-diferencias',
  ...
  '10 jul 2026',
  'Desarrollo',
  '/assets/blog/dominio-hosting.jpg',
